...
export const CutCornerButton = (props: ComponentPropsWithoutRef<"button">) => {
  ...
  return (
    <button className={twMerge(
      "bg-fuchsia-500/20 px-4 py-2 font-extrabold uppercase font-heading text-sm tracking-wider relative [mask-image:linear-gradient(225deg,transparent,transparent_8px,black_8px)]",
      className,
    )}>
